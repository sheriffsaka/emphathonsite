    ...
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
        <div className="space-y-8">
          ...
          <div className="w-full h-32 skeleton rounded-3xl" />
          <div className="w-3/4 h-20 skeleton rounded-2xl" />
          <div className="flex space-x-4">
            <div className="w-48 h-16 skeleton rounded-full" />
            <div className="w-48 h-16 skeleton rounded-full" />
          </div>
        </div>
        <div className="w-full aspect-square skeleton rounded-[40px]" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {Array(3).fill(0).map((_, i) => (
          <div key={i} className="h-64 skeleton rounded-[40px]" />
        ))}
      </div>
    </div>
  </div>
...
const Corporate: React.FC = () => {
  ...
  return (
    <div className="pt-32 pb-20 bg-neutral-950 min-h-screen animate-in fade-in duration-700">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          <div>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <button className="bg-brand-orange text-white px-10 py-5 rounded-full font-black flex items-center justify-center space-x-3 hover:scale-105 transition-all shadow-xl shadow-brand-orange/20">
                <span>Request a Proposal</span>
                <ChevronRight size={20} />
              </button>
              <button className="glass-dark px-10 py-5 rounded-full font-black border border-white/10 hover:bg-white/5 transition-all text-white">
                Download Brochure
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          <div className="glass-dark p-12 rounded-[40px] border border-white/5 hover:border-brand-orange/20 transition-all group">
            <ShieldCheck size={48} className="text-brand-orange mb-8 group-hover:scale-110 transition-transform" />
            <h3 className="text-2xl font-bold mb-4 text-white">Risk Management</h3>
          ...
          <div className="glass-dark p-12 rounded-[40px] border border-white/5 hover:border-brand-orange/20 transition-all group">
            <Globe size={48} className="text-brand-orange mb-8 group-hover:scale-110 transition-transform" />
          ...
          <div className="glass-dark p-12 rounded-[40px] border border-white/5 hover:border-brand-orange/20 transition-all group">
            <Handshake size={48} className="text-brand-orange mb-8 group-hover:scale-110 transition-transform" />
            <h3 className="text-2xl font-bold mb-4 text-white">Dedicated Account Manager</h3>
            <p className="text-gray-400">24/7 priority support for maintenance, upgrades, and fleet logistics.</p>
          </div>
        </div>

        {/* Inquiry Form */}
        <div className="glass-dark rounded-[60px] overflow-hidden border border-white/10 p-10 md:p-20 relative">
          <div className="absolute top-0 right-0 p-20 opacity-5 pointer-events-none">
            <Briefcase size={400} />
          </div>
          <div className="max-w-2xl relative z-10">
            <h2 className="text-4xl md:text-5xl font-black mb-6 text-white">Corporate <span className="text-brand-orange">Inquiry</span></h2>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 outline-none focus:border-brand-orange/50 transition-all text-white" placeholder="Acme Corp" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Industry</label>
                  <input type="text" className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 outline-none focus:border-brand-orange/50 transition-all text-white" placeholder="Technology" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Estimated Fleet Size</label>
                <select className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 outline-none focus:border-brand-orange/50 appearance-none text-white cursor-pointer">
              ...
              <div className="space-y-2">
                ...
                <textarea rows={4} className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 outline-none focus:border-brand-orange/50 resize-none text-white" placeholder="Bespoke requirements..."></textarea>
              </div>
              <button className="w-full bg-brand-orange text-white py-5 rounded-2xl font-black text-lg hover:scale-[1.02] transition-transform shadow-xl shadow-brand-orange/20">
                Send Request
              </button>
            </form>
          </div>
